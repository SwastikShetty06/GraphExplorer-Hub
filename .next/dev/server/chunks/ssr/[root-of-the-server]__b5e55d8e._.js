...
async function UserProfile({ params }) {
    ...
    // We need a way to make authenticated requests on the server.
    // We'll create a lib/apollo-server.js or similar helper.
    // For now, let's assume getClient() works and handles auth using session.accessToken
    // Actually, passing the token to the server-side client is specific.
    // We'll need to implement that utility first.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5e55d8e._.js.map