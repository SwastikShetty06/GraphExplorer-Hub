/* [project]/node_modules/github-markdown-css/github-markdown.css [app-client] (css) */
.markdown-body {
  --base-size-4: .25rem;
  --base-size-8: .5rem;
  --base-size-16: 1rem;
...
.markdown-body ol[type="1"], .markdown-body div > ol:not([type]) {
...
.markdown-body [role="button"]:focus:not(:focus-visible), .markdown-body [role="tabpanel"][tabindex="0"]:focus:not(:focus-visible), .markdown-body button:focus:not(:focus-visible), .markdown-body summary:focus:not(:focus-visible), .markdown-body a:focus:not(:focus-visible) {
  box-shadow: none;
  outline: none;
}
...
/*# sourceMappingURL=node_modules_github-markdown-css_github-markdown_1b8fdd78.css.map*/